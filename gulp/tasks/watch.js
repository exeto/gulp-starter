...
const paths = {
  ...
  sprite: path.join(cfg.root.src, cfg.static.src, cfg.img.src, cfg.sprite.src, '/**/*.png'),
  spriteSvg: path.join(cfg.root.src, cfg.static.src, cfg.img.src, cfg.spriteSvg.src, '/**/*.svg'),
